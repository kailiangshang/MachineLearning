...
def BestModel(X, y):
    ...
    # 网格化搜索参数
    g_search = GridSearchCV(estimator=RandomForestClassifier(oob_score=True), param_grid=param_dict,
...
def main():
    ...
    # 3.predict()   模型预测
    RF = RandomForestClassifier(oob_score=True, n_estimators=param_dict['n_estimators'],
